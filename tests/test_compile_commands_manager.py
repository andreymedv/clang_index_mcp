...
class TestCompileCommandsManager(unittest.TestCase):
    ...
    def test_load_compile_commands_invalid_json(self):
        ...
        config = {
            ...
            "compile_commands_path": "invalid_compile_commands.json",
        }
        manager = CompileCommandsManager(self.project_root, config)
    ...
    def test_load_compile_commands_missing_file_field(self):
        ...
        config = {
            "compile_commands_enabled": True,
            "compile_commands_path": "invalid_commands.json",
        }
        manager = CompileCommandsManager(self.project_root, config)
    ...
    def test_filter_arguments_recognizes_compiler_paths(self):
        ...
        test_cases = [
            ...
            (
                ["C:\\Program Files\\LLVM\\bin\\clang++.exe", "-std=c++17", "-DTEST"],
    ...
    def test_fallback_args_windows(self):
        ...
        with patch("sys.platform", "win32"):
            with patch("glob.glob") as mock_glob:
                ...
                self.assertIn(
                    "-IC:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/ucrt", args
                )
