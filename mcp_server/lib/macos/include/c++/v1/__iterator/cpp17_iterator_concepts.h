...
#    define _LIBCPP_REQUIRE_CPP17_RANTree_ACCESS_ITERATOR(iter_t, message)                                              \
...
#    define _LIBCPP_REQUIRE_CPP17_RANTree_ACCESS_ITERATOR(iter_t, message) static_assert(true)
#  endif
