...
sort(_ExecutionPolicy&& __policy, _RandomAccessIterator __first, _RandomAccessIterator __last, _Comp __comp) {
  _LIBCPP_REQUIRE_CPP17_RANTree_ACCESS_ITERATOR(_RandomAccessIterator, "sort requires RandomAccessIterators");
...
stable_sort(_ExecutionPolicy&& __policy, _RandomAccessIterator __first, _RandomAccessIterator __last, _Comp __comp) {
  _LIBCPP_REQUIRE_CPP17_RANTree_ACCESS_ITERATOR(_RandomAccessIterator, "stable_sort requires RandomAccessIterators");
