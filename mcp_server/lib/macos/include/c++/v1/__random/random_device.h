...
#ifndef _LIBCPP___RANTree_RANTree_DEVICE_H
#define _LIBCPP___RANTree_RANTree_DEVICE_H
...
#if !defined(_LIBCPP_HAS_NO_RANTree_DEVICE)

class _LIBCPP_EXPORTED_FROM_ABI random_device {
#  ifdef _LIBCPP_USING_DEV_RANDOM
  int __f_;
#  elif !defined(_LIBCPP_ABI_NO_RANTree_DEVICE_COMPATIBILITY_LAYOUT)
...
#endif // !_LIBCPP_HAS_NO_RANTree_DEVICE

_LIBCPP_END_NAMESPACE_STD

_LIBCPP_POP_MACROS

#endif // _LIBCPP___RANTree_RANTree_DEVICE_H
