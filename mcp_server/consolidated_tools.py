    ...
    return [
        ...
        Tool(
            ...
            description=(
                ...
                "- file_name: restrict to files/dirs (e.g., 'tests/', 'Tree_', 'Helper')\n"
                "  Examples: pattern='' with file_name='Tree_' finds all symbols in Tree_ files\n"
        ...
        Tool(
            ...
            description=(
                ...
                "(e.g., file_name='tests/', file_name='Tree_')."
            ),
            inputSchema={
                "type": "object",
                "properties": {
