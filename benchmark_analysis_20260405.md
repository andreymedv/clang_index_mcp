...
**Example Failure:**
- Query: `"What symbols are defined in Tree_Document.h?"` → Some models don't use `find_in_file`
...
**Example Failures:**
- Query: `"How is ApplyStyle used with Tree elements? Find the function first, then show me its callers"`
